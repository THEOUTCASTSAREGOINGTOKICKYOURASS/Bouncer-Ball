...
void ABouncerHUD::DrawHUD()
{
	...
	FVector2D ScoreSize, ScoreSize1, ScoreSize2, ScoreSize3, ScoreSize4;
	GetTextSize(CurrentPointString1, ScoreSize1.X, ScoreSize1.Y, HUDFont);
	GetTextSize(CurrentPointString1, ScoreSize2.X, ScoreSize2.Y, HUDFont);
	GetTextSize(CurrentPointString1, ScoreSize3.X, ScoreSize3.Y, HUDFont);
	GetTextSize(CurrentPointString1, ScoreSize4.X, ScoreSize4.Y, HUDFont);
